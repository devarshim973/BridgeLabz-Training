...
public class BankAccountnew {
    ...
    public BankAccountnew(String accountHolderName, String accountNumber, double balance) {
    ...
    public void displayAccountDetails() {
        // Using instanceof to check if the object is a BankAccountnew instance
        if (this instanceof BankAccountnew) {
    ...
    public static void main(String[] args) {
        ...
        BankAccountnew account1 =
                new BankAccountnew("Lynda Princy", "ACC12345", 1000.00);
        BankAccountnew account2 =
                new BankAccountnew("Prince Danish", "ACC67890", 500.00);
